...
- [Excel Formulas](#excel-formulas)
  - [Contenido](#content)
      - [Manipulacion de texto](#manipulacion-de-texto)
        - [Encontrar si hay un espacio vacio en una celda](#encontrar-si-hay-un-espacio-vacio-en-una-celda)
        - [Buscar un valor usando dos columnas como referencia](#buscar-un-valor-usando-dos-columnas-como-referencia)
        - [Eliminar los espacios vacios de las celdas](#eliminar-los-espacios-vacios-de-las-celdas)
        - [Encontrar una palabra específica en una celda y categorizarla](#encontrar-una-palabra-especifica-en-una-celda-y-categorizarla)
        - [Reemplazar un #ERROR con algún texto](#reemplazar-un-error-con-algun-texto)
     - [Formato de Fechas](#formato-de-fechas)
        - [Machete para convertir a diferente tipo de formatos](#machete-para-convertir-a-diferente-tipo-de-formatos) 
